	...
	, "Methods" : [
		{
			...
			, "Description" : [
				...
				+ " By stuffing everything into one explorable variable J dramatically simplifies the process "
				...
				+ " (think RequireJS), well until ES6 becomes the standard."
				+ " But that does not mean a more refined and elegant approach is not possible or even needed."
				, "jDog differs from the AMD style in many ways that make it superior for development and production."
				, "<h4>That is a bold claim!</h4>"
				, "For nodeJS require() syntax makes sense. Everything is loaded ahead of time. "
				...
				, "RequireJS tackles this with define, where you map the path to the name. "
				+ " Generally this works, but it does it in a way that makes bundling difficult. "
